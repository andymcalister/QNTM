...
def page_screener():
    ...
    <div style="padding:32px 32px 0;">
      <h1 style="font-family:'Syne',sans-serif;font-size:28px;font-weight:800;">Market Screener</h1>
      <p style="color:#475569;margin-top:4px;font-size:13px;">S&P 500 universe (0 stocks) + search any ticker · 5 pillars · 75/25 quant/macro blend</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    if search_ticker:
        ...
        with st.spinner(f"Scoring {search_ticker}..."):
            try:
                ...
                macro = st.session_state.get("macro_data") or fetch_macro_overlay(use_live_feeds=False)
